...
<p class="lead"><a href="/dimensions">LSD Dimensions</a> is an observatory of the current usage of <a href="http://www.w3.org/TR/vocab-data-cube/#dsd-dsd" target="_blank">Data Structure Definitions</a> (DSDs), <a href="http://www.w3.org/TR/vocab-data-cube/#cubes-model" target="_blank">dimensions</a> and <a href="http://www.w3.org/TR/vocab-data-cube/#schemes" target="_blank">codes</a> in Linked Statistical Data (LSD).</p>

<p class="text-justify"><a href="/dimensions">LSD Dimensions</a> is an aggregator of all qb:DataStructureDefinition and qb:DimensionProperty resources (and their associated triples), as defined in the <a href="http://www.w3.org/TR/vocab-data-cube/" target="_blank">RDF Data Cube vocabulary</a> (W3C recommendation for publishing statistical data on the Web), that can be currently found in the <a href="http://linkeddata.org/" target="_blank">Linked Data Cloud</a> (read: the SPARQL endpoints in <a href="http://datahub.io/" target="_blank">Datahub.io</a>). Its purpose is to improve the reusability of statistical dimensions, codes and concept schemes in the Web of Data, providing an interface for users (future work: also for programs) to search for resources commonly used to describe open statistical datasets. The gathering of all DSDs is intended for developing ways of enhancing comparability of Linked Statistical Data by leveraging semantically rich descriptions of cube components.</p>
